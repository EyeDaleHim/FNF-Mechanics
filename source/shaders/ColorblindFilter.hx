...
{
	public static var deuteranopia:{filter:BitmapFilter, apply:String->Void} = {
	...
	public static var protanopia:{filter:BitmapFilter, apply:String->Void} = {
		filter: new ColorMatrixFilter([
			0.20, 0.99, -.19, 0, 0,
			0.16, 0.79, 0.04, 0, 0,
			0.01, -.01,    1, 0, 0,
	...
	public static var tritanopia:{filter:BitmapFilter, apply:String->Void} = {
		filter: new ColorMatrixFilter([
			0.97, 0.11, -.08, 0, 0,
			0.02, 0.82, 0.16, 0, 0,
			0.06, 0.88, 0.18, 0, 0,
