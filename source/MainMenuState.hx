...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		if (leDate.getDay() == 5 && leDate.getHours() >= 18)
		{
			...
			if (!Achievements.isAchievementUnlocked(Achievements.achievementsStuff[achieveID].tag))
			{ // It's a friday night. WEEEEEEEEEEEEEEEEEE
				Achievements.achievementsMap.set(Achievements.achievementsStuff[achieveID].tag, true);
				giveAchievement();
