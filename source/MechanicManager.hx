...
class MechanicManager
{
	public static var mechanics:Map<String, MechanicData> = [
        ...
        'drain_hp' => new MechanicData('HP Drain', 'Your HP drains over time. With a limit', 'healthdr1', 6),
        'hit_hp' => new MechanicData('HP Killer', 'Your opponent can fight back when they hit a note', 'healthdr2', 7),
        'note_speed' => new MechanicData('Random Speed', 'Each note individually will have a random speed', 'notespeed', 8),
        'dodging' => new MechanicData('Dodging', 'You will get attacked at random, you have to react more quickly depending on the points', 'dodge', 9),
        'note_change' => new MechanicData('Note Changer', 'A note will change from it\'s original position. Affects all type of notes', 'random1', 10),
        'note_random' => new MechanicData('Random Notes', 'Random Notes will scatter randomly throughout the chart', 'random2', 11),
