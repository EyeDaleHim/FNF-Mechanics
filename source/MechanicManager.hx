...
class MechanicManager
{
	public static var mechanics:Map<String, MechanicData> = [
        ...
        'sleep_note' => new MechanicData('Sleepy Note', 'Hitting a Sleepy Note will increase your sleep bar, which will diminish slowly', 'sleepnote', 5),
        ...
        'mouse_follower' => new MechanicData('Mouse Follower', 'A green mouse will follow your own mouse, just don\'t let it overlap your own mouse', 'fakemouse', 14),
