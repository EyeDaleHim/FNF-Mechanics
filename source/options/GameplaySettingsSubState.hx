...
class GameplaySettingsSubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Time Rating', "If checked, hitting a note will display how late or early your hit was.", 'timeHit', 'bool', false);
		addOption(option);

		var option:Option = new Option('Music Channel', "If the music should be playing on different forms of channels, depending on the option.", 'channel',
			'string', 'Stereo', ['Mono', 'Stereo']);
		addOption(option);

		var option:Option = new Option('Music Always Sync', "If checked, the music will always be synced, will cause visual jittering issues with notes.",
			'musicSync', 'bool', false);
		addOption(option);

		var option:Option = new Option('Auto Pause', "If the game should autopause when you focus out of it",
