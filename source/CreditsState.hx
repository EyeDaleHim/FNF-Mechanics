...
class CreditsState extends MusicBeatState
{
	...
	public static var baseCredits:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
		['Psych Engine Team'],
	...
	override function create()
	{
		...
		creditsStuff.unshift(['EyeDaleHim', 'eyedalehim', 'Creator & Programmer of FNF Mechanics Mod', 'https://https://twitter.com/him_dale', 'FF9300']);
