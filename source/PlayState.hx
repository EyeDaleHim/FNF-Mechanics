...
class PlayState extends MusicBeatState
{
	 ...
	 */
		...
		if (generatedMusic)
		{
			...
			notes.forEachAlive(function(daNote:Note)
			{
				...
				if (!daNote.mustPress && daNote.wasGoodHit && !daNote.hitByOpponent && !daNote.ignoreNote && !daNote.autoGenerated)
				{
	...
	private function popUpScore(note:Note = null):Void
	{
		...
		if (!practiceMode && !cpuControlled && !note.autoGenerated)
		{
